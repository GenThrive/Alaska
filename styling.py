...
# PAGE SETTINGS
# ----------------------------------------------------------------------------
app_title = 'Alaska Environmental Education Directory'
page_title = 'Alaska Environmental Education Directory'
sub_title = 'Filter on'
...
# MAP SETTINGS
# ----------------------------------------------------------------------------
map_center_lat = 64.5836187
map_center_lon = -170.5823156
map_zoom = 2.172
